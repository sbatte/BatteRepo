...
<body style="background-color:white;" id="bodysty">
        ...
        <table  width="100%" border="0" id="tab">
            ...
            <form:form modelAttribute="admin" >
             ...
             <tr><th>  Admin Account Information</b></th></tr>
                  <tr><td> Username:*</td><td><form:input path="email" type="text" size="25" onblur="validation()"/><span id="emsg" style="padding-left:55%;">  </span></td> </tr>
                  <tr><td>  Password:*</td><td><form:input path="password" type="password" size="25" onblur="validation()"/><span id="pmsg"></span> </td> </tr>
                  ...
                  <tr><td>
                   ...
                   <input style="margin-left:30%;"  type="submit" value="Register"></td><td><input type="reset" value="Reset"></td>
