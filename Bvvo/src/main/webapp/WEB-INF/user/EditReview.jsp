 ...
 <body style="background-color:white;">
        ...
        <table  width="100%" border="0" id="tab">
            ...
            <span style="border-right: #C8BBBE thin solid;"><a href="SearchReview.html">Search Review</a></span>
                ...
                <br><br>
                 <form:form modelAttribute="rating" method="post">
...
<form:hidden path="email.id" value="${ses.id}"/>
<form:hidden path="lawyername.id" value="${lawyersession.id}"/></tr>

<tr><td>
 <input type="submit" name= "submit" value="Save"><input type="reset" value="Reset" ></td></tr>
</table>
</form:form>
</body>
</html>